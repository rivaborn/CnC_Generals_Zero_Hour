# Generals/Code/GameEngineDevice/Source/W3DDevice/GameClient/GUI/Gadget/W3DTabControl.cpp
...
## Key Types
- `TabControlData` (struct): Stores tab control configuration (tab count, positions, dimensions, active tab, disabled state)
...
## Globals
- `TheWindowManager` (WindowManager*): Global window manager instance for UI rendering operations
