# Generals/Code/GameEngineDevice/Include/W3DDevice/GameClient/Module/W3DTankDraw.h
...
## Key Types
- **W3DTankDrawModuleData (Class)**: Stores tank-specific rendering parameters (tread debris names, animation rates)
...
- **TreadObjectInfo (Struct)**: Contains render object and material settings for individual treads

## Key Functions
### W3DTankDraw::doDrawModule
- Purpose: Renders the tank with tread animations and debris effects
