# Generals/Code/GameEngineDevice/Include/W3DDevice/GameClient/W3DShadow.h
...
- Handles shadow color and light position settings
- Controls shadow scene state and stencil masking
