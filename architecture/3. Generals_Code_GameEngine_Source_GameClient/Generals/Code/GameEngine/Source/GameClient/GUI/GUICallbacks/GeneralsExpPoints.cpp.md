# Generals/Code/GameEngine/Source/GameClient/GUI/GUICallbacks/GeneralsExpPoints.cpp
...
- Manages focus and input focus changes
- Handles button click events (e.g., exit button)
- Clears building placement mode when entering exp screen
