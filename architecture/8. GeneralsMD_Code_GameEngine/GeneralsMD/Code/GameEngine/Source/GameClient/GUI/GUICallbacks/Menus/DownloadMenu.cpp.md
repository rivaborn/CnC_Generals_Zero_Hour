...
## Key Functions
### closeDownloadWindow
- Purpose: Closes the download window and restores focus to the main menu
- Calls: `runShutdown`, `destroyWindows`, `deleteInstance`, `winGetWindowFromId`, `winSetFocus`
...
### successQuitCallback
- Purpose: Handles successful downloads requiring a game restart
- Calls: `setQuitting`, `closeDownloadWindow`, `appendMessage`

### successNoQuitCallback
- Purpose: Handles successful downloads not requiring a restart
- Calls: `HandleCanceledDownload`, `closeDownloadWindow`
...
- Calls: `BitTest`, `nameToKey`, `winGetWindowFromId`, `winSendSystemMsg`
