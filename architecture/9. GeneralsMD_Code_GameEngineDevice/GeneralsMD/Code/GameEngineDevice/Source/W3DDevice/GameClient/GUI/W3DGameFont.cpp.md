...
- `GameFont` (Struct): Font descriptor
- `FontCharsClass` (Class): W3D font asset
...
### `releaseFontData`
- Purpose: Releases font resources and cleans up references
- Calls: `Release_Ref()`

## Globals
- `TheGlobalLanguageData` (External): Global language configuration
