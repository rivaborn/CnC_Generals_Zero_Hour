...
## Key Functions
### MOTDSystem
- Purpose: Processes window messages for the MOTD system
- Calls: TheNameKeyGenerator->nameToKey, window->winHide, window->winIsHidden

## Globals
- closeButtonID (NameKeyType): Stores the ID of the MOTD close button
