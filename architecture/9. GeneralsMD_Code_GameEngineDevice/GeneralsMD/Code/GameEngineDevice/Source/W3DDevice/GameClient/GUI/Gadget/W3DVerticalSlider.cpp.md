...
## Purpose
Implements drawing logic for vertical slider gadgets in the game UI.

## Responsibilities
- Renders colored vertical sliders using standard graphics
- Renders vertical sliders with user-supplied images
- Handles different visual states (enabled, disabled, hilited)
- Manages image tiling and positioning for slider components
...
- Purpose: Draws a vertical slider using user-supplied images with proper tiling
