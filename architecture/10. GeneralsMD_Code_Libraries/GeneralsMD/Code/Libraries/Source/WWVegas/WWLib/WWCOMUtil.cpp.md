...
- Manages HRESULT error propagation
...
- Calls: LoadLibrary, GetProcAddress, FreeLibrary
...
## Dependencies
- WWCOMUtil.h
- COM interfaces: IDispatch, IID_NULL
- Windows API: LoadLibrary, GetProcAddress, FreeLibrary
- Types: HRESULT, HINSTANCE, FARPROC, DISPID, DISPPARAMS, VARIANT, OLECHAR
