# GeneralsMD/Code/Libraries/Source/WWVegas/WW3D2/txt2d.cpp
...
- Handles texture generation for text
- Adjusts text for screen resolution and pixel alignment

## Key Types
- Text2DObjClass (Class): Manages 2D text rendering with font, position, and texture handling
...
- Purpose: Sets text content and rendering parameters for the object
- Calls: WW3D::Get_Device_Resolution, TextTexture.Build_Texture, TextTexture.Get_Texture, TextTexture.Get_Texture_Size, font.String_Pixel_Width, font.Get_Height, Resize, Set_Texture, Set_Shader, Enable_Sort, Begin_Tri_Strip, End_Tri_Strip, WW3D::Get_Pixel_Center, Set_Position, Set_Dirty
