...
## Purpose
Defines the `SurfaceClass` wrapper for Direct3D surfaces, providing surface manipulation utilities.
...
- Supports font rendering and texture operations

## Key Types
- `SurfaceClass` (Class): Main surface wrapper with Direct3D surface operations
