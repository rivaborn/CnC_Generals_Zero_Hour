# Generals/Code/Libraries/Source/WWVegas/WWAudio/AudibleSound.h
...
- Calls: `Allocate_Miles_Handle`, `Set_Miles_Handle`
...
## Dependencies
- `mss.h` (MILES audio system)
- `vector3.h`, `matrix3d.h` (3D math)
- `refcount.h`, `rawfile.h`, `soundsceneobj.h` (engine utilities)
- `wwstring.h`, `definition.h` (string/definition systems)
