# Generals/Code/Libraries/Source/WWVegas/WWLib/dsurface.cpp
...
- Supports high-color pixel format conversions
...
- DDSURFACEDESC (Struct): DirectDraw surface description structure
- DDPIXELFORMAT (Struct): Pixel format description
...
## Dependencies
- DirectDraw headers (ddraw.h)
- XSurface base class
- PaletteClass for color operations
- W3D memory allocation (W3DNEW)
