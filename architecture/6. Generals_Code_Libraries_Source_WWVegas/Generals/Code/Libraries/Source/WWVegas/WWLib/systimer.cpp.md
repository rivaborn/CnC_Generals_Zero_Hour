# Generals/Code/Libraries/Source/WWVegas/WWLib/systimer.cpp
...
- Provides time measurement and wrap-around handling
...
### SysTimeClass::Reset
- Purpose: Resets the timer to current time and initializes wrap-around value
- Calls: timeGetTime()
