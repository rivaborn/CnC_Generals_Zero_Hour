# Generals/Code/Libraries/Source/WWVegas/WWLib/hsv.cpp

## Purpose
Implements HSV (Hue, Saturation, Value) color operations and conversion to RGB.

## Responsibilities
- Adjust HSV colors toward a target color with a specified ratio
- Calculate color differences between two HSV objects
...
### HSVClass::Difference
- Purpose: Computes the difference between two HSV colors as a squared distance metric
- Calls: None
