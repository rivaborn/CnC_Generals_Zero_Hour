# Generals/Code/Libraries/Source/WWVegas/WWLib/_xmouse.h

## Purpose
Header file providing inline wrapper functions for mouse cursor management.
...
### Get_Mouse_State
- Purpose: Returns current mouse state
...
## Globals
- MouseCursor (Mouse*): Global pointer to mouse cursor object

## Dependencies
- xmouse.h (included)
- Mouse class (external)
