# Generals/Code/Libraries/Source/WWVegas/WWLib/xsurface.cpp
...
- `Point2D` (Struct): 2D point definition
...
### `XSurface::Draw_Line`
- Purpose: Draw lines with clipping
- Calls: `Lock`, `Unlock`

### `XSurface::Fill_Rect`
- Purpose: Fill rectangles with color
- Calls: `Lock`, `Unlock`

### `XSurface::Blit_Plain`
- Purpose: Perform non-transparent blits
- Calls: `Bit_Blit`

### `XSurface::Blit_Trans`
- Purpose: Perform transparent blits
- Calls: `Bit_Blit`
