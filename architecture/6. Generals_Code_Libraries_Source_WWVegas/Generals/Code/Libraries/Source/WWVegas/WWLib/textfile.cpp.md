# Generals/Code/Libraries/Source/WWVegas/WWLib/textfile.cpp
...
- Manage file position during reading
...
- Calls: Read, Seek, StringClass::Empty, StringClass::operator+=, StringClass::Get_Length, StringClass::Peek_Buffer, StringClass::Erase

### Write_Line
- Purpose: Writes a line of text to the file with CR/LF termination
- Calls: Write, StringClass::Get_Length
