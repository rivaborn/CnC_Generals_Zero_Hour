# Generals/Code/Libraries/Source/WWVegas/WWLib/msgloop.h

## Purpose
Header file defining the Windows message loop interface for the game.

## Responsibilities
- Declares the main Windows message handler.
- Provides functions for managing modeless dialog boxes.
- Declares functions for accelerator key support.
- Defines a global message intercept handler callback.
