# Generals/Code/Libraries/Source/WWVegas/WWLib/msgloop.cpp
...
## Key Types
- **AcceleratorTracker (struct)**: Tracks window accelerators (HWND, HACCEL)
...
- `_Accelerators (DynamicVectorClass<AcceleratorTracker>)`: Tracks registered accelerators
- `Message_Intercept_Handler (bool (*)(MSG &))`: Custom message interception callback
