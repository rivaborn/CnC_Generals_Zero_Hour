# Generals/Code/Libraries/Source/WWVegas/WWLib/BUFF.H
...
## Key Types
- Buffer (Class): wraps a memory buffer pointer and its size for safer handling
...
- Purpose: Assign buffer data from another Buffer instance
- Calls: None
...
- Standard C++ types (void*, char*, long)
