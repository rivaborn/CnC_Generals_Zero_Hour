# Generals/Code/Libraries/Source/WWVegas/WWLib/blwstraw.h
...
## Key Types
- **BlowStraw (Class)**: Wraps Blowfish encryption/decryption for data streams
...
### ~BlowStraw()
- Purpose: Destructor cleaning up the Blowfish engine
- Calls: `delete BF`
