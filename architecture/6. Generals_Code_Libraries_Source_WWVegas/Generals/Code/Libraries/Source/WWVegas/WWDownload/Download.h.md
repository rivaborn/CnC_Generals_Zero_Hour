# Generals/Code/Libraries/Source/WWVegas/WWDownload/Download.h
...
## Dependencies
- `WWDownload/ftp.h`: FTP functionality.
- `WWDownload/downloaddefs.h`: Download status definitions.
- `Cftp`: External FTP class used for downloads.
