# Generals/Code/Libraries/Source/WWVegas/WWMath/catmullromspline.cpp

## Purpose
Implements Catmull-Rom spline classes for 1D and 3D interpolation, including tangent calculation and persistence.

## Responsibilities
- Computes tangents for Catmull-Rom splines (3D and 1D)
- Provides persistence (save/load) for spline data
- Manages spline key points and tangents
- Handles looping and non-looping spline cases
...
- Purpose: Saves 3D spline data to chunk
- Calls: HermiteSpline3DClass::Save

### CatmullRomSpline3DClass::Load
- Purpose: Loads 3D spline data from chunk
...
- Purpose: Saves 1D spline data to chunk
- Calls: HermiteSpline1DClass::Save

### CatmullRomSpline1DClass::Load
- Purpose: Loads 1D spline data from chunk
