...
## Key Types
- **DistLODDefClass** (Class): Blueprint for creating DistLOD models
- **DistLODClass** (Class): Runtime LOD model container
- **DistLODLoaderClass** (Class): W3D file loader for DistLOD models
- **DistLODNodeDefStruct** (Struct): Stores LOD node definition data
- **LODNodeClass** (Struct): Runtime LOD node container
...
## Dependencies
- distlod.h, nstrdup.h, ww3d.h, assetmgr.h, camera.h, w3derr.h, wwdebug.h, chunkio.h, hlod.h, rinfo.h, coltest.h, inttest.h
- WW3DAssetManager, ChunkLoadClass, RenderObjClass, HLodClass, Matrix3D, Vector3
