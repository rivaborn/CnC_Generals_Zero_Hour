...
## Key Types
- STLSpecialAlloc (Class): Custom allocator wrapper for STL compatibility
...
- Purpose: Main entry point that scans a W3D file for dependencies
...
### Scan_Mesh_Textures
- Purpose: Extracts texture filenames from mesh textures
- Calls: None (direct file reading)

### Scan_Anim
- Purpose: Scans animation chunks for hierarchy references
- Calls: Make_W3D_Filename

### Scan_HModel
- Purpose: Scans hierarchical model chunks for hierarchy references
- Calls: Make_W3D_Filename

### Scan_Emitter
- Purpose: Extracts texture references from emitter information
- Calls: None

### Scan_Aggregate
- Purpose: Scans aggregate objects for base model and subobject references
- Calls: Make_W3D_Filename
