# Generals/Code/Libraries/Source/WWVegas/WW3D2/inttest.h
...
- Purpose: Cull test against another axis-aligned box defined by min/max vectors
- Calls: `Vector3::Subtract`, `Vector3::Add`

### `AABoxIntersectionTestClass::Cull(const AABoxClass &)`
- Purpose: Cull test against another axis-aligned box
